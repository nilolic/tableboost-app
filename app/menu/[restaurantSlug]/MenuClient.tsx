                  ...
                  <div key={item.id} className={`group bg-white rounded- border p-3 flex gap-3 shadow-sm hover:shadow-md transition-all ${item.isBoosted? 'border-amber-300 bg-amber-50/30' : 'border-zinc-100 hover:border-zinc-200'}`}>
                    ...
                    <div className="flex-1 min-w-0 flex flex-col">
                      <div className="flex justify-between items-start gap-2">
                        ...
                        {item.anchorPrice != null && <span className="bg-orange-600 text-white text-[12.5px] font-black px-2.5 py-1 rounded-full">Cijena 10.09: {Number(item.anchorPrice).toFixed(2)}€</span>}
                      </div>
                      </div>
                      ...
                      <div key={item.id} className={`group bg-white rounded- border p-3 flex gap-3 shadow-sm hover:shadow-md transition-all ${item.isBoosted? 'border-amber-300 bg-amber-50/30' : 'border-zinc-100 hover:border-zinc-200'}`}>
                        ...
                        <div className="flex-1 min-w-0 flex flex-col">
                          <div className="flex justify-between items-start gap-2">
                            ...
                            {item.anchorPrice != null && <span className="bg-orange-600 text-white text-[11.5px] font-black px-2 py-1 rounded-full">Cijena 10.09: {Number(item.anchorPrice).toFixed(2)}€</span>}
                          </div>
                          </div>
