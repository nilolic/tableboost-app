    ...
    <div className="min-h-screen bg-[#fdf8f3] text-zinc-900 selection:bg-black selection:text-white">
      ...
      {showCart && (
        <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm flex items-end justify-center p-0 md:p-4">
          <div className="bg-white w-full max-w-2xl rounded-t-[28px] md:rounded-[28px] max-h-[90vh] flex flex-col shadow-2xl overflow-hidden" style={{ maxHeight: '100dvh' }}>
            ...
            <div className="p-4 border-t bg-zinc-50 space-y-3 mt-6" style={{ paddingBottom: '140px' }}>
