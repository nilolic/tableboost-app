    ...
    <main className="p-8 bg-white min-h-screen">
      <div className="max-w-5xl mx-auto">
        <div className="flex justify-between items-center mb-8 print:hidden">
          ...
          <button onClick="window.print()" className="bg-black text-white px-6 py-3 rounded-xl font-bold">
            Print / Save PDF
          </button>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
          {tables.map(table => {
            ...
            return (
              <div key={table.id} className="border-2 border-black rounded-2xl p-6 text-center break-inside-avoid">
